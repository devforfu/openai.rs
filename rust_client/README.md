# Rust API client for openai_api
...
Put the package under your project folder in a directory named `openai_api` and add the following to `Cargo.toml` under `[dependencies]`:
