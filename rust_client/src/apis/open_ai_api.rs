...
pub async fn cancel_fine_tune(configuration: &configuration::Configuration, fine_tune_id: &str) -> Result<crate::models::FineTune, Error<CancelFineTuneError>> {
    ...
    if let Some(ref bearer_token) = local_var_configuration.bearer_access_token {
        local_var_req_builder = local_var_req_builder.bearer_auth(bearer_token.clone());
    }
...
pub async fn create_chat_completion(configuration: &configuration::Configuration, create_chat_completion_request: crate::models::CreateChatCompletionRequest) -> Result<crate::models::CreateChatCompletionResponse, Error<CreateChatCompletionError>> {
    let local_var_configuration = configuration;
...
pub async fn create_transcription(configuration: &configuration::Configuration, file: std::path::PathBuf, model: &str, prompt: Option<&str>, response_format: Option<&str>, temperature: Option<f32>, language: Option<&str>) -> Result<crate::models::CreateTranscriptionResponse, Error<CreateTranscriptionError>> {
    let local_var_configuration = configuration;
...
pub async fn create_translation(configuration: &configuration::Configuration, file: std::path::PathBuf, model: &str, prompt: Option<&str>, response_format: Option<&str>, temperature: Option<f32>) -> Result<crate::models::CreateTranslationResponse, Error<CreateTranslationError>> {
    let local_var_configuration = configuration;
